...
if(isset($_POST['newpass']))
{
    ...
    // $sql = "update user set uname='{$pass}' where uemail='{$email}'";
    // $queryselect="SELECT uid FROM user WHERE uemail = '".$_POST['email']."'";
    $sql1 ="UPDATE user SET user.upass='{$pass}' WHERE uid='{$uid}'";
                	...
                	<div class="loginbox">
                        <div class="login-right">
							<div class="login-right-wrap">
								<h1 style="margin-bottom: 20px;">Enter New Password</h1>
								...
								<form method="post">
									<div class="form-group">
										...
										<button class="btn btn-success" name="newpass" value="Login" type="submit">Change Password</button>
