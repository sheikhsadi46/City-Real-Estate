...
if(isset($_POST['insert']))
{
	...
	if(!empty($content))
	{
		...
		$sql="INSERT INTO feedback (uid,fdescription,status,pid) VALUES ('$uid','$content','0',$pid)";+
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="row mb-4">
                            <div class="col-md-6">
                                <div class="bg-success d-table px-3 py-2 rounded text-white text-capitalize"><a href="payment.php?pid=<?php echo $row['0'];?>">For <?php echo $row['5'];?></a></div>
...
<!-- --****************************COMMENT***********************************************----- -->
                            ...
                            <div class="row">
                                ...
                                <form action="#" method="post">
                                    ...
                                    <textarea class="form-control" name="content" rows="2" placeholder="Enter Text Here...."></textarea>
                                    <br>
                            ...
                            <div class="row">
                                ...
                                <?php 
                                    $id=$_REQUEST['pid'];
                                    $query=mysqli_query($con,"SELECT * FROM `feedback` WHERE pid='$id'");
                                        while($row5=mysqli_fetch_array($query))
                                        {?>
                                        <tr>
                                        <td> <?php echo $row5['2'];?></td>
                                        
                                        <td><a class="btn btn-info"  href="commentreport.php?id=<?php echo $row5['0'];?>">Report</a></td>
                                        </tr>
                                        <?php } ?>
                                        </tbody>
                                        </table>
					  ...
					  ?>
                        ...
                        <form class="d-inline-block w-100" action="calc.php" method="post">
                            ...
                            <div class="input-group mb-2 mr-sm-2">
                                ...
                                <input type="text" class="form-control" name="amount" placeholder="Property Price" value="<?php echo $row['13']; ?>">
                                <?php } ?>
                            </div>
