                	...
                	<div class="loginbox">
                        <div class="login-right">
							<div class="login-right-wrap">
								<h1 style="text-align : center; color:rgb(40,167,69);"><b>Register</b></h1>
								...
								<form method="post" enctype="multipart/form-data">
									...
									<h4 style="text-align : center; color:rgb(40,167,69);"><b>Address</b></Address> </h4>
									<div class="form-group">
									...
									<h4 style="text-align : center; color:rgb(40,167,69);"><b>Social Links</b></Address> </h4>
									<div class="form-group">
										<input type="url"  name="fblink" class="form-control" placeholder="Your Facebook Id link*">
									</div>
